...
export const faqs: Faq[] = [
	{ id: 'fechas-gira', pregunta: '¿Cuándo se realiza la Gira?', variantes: ['¿Cuáles son las fechas de la gira?', '¿Qué día comienza y termina?', '¿Cuándo parte AGROCOOPINNOVA 2026?', '¿Entre qué fechas es la gira?'], respuesta: 'La llegada de participantes está programada para el domingo 6 de septiembre de 2026. Las jornadas de actividades se desarrollan desde el lunes 7 hasta el viernes 11 de septiembre de 2026.', categorias: ['programa', 'fechas'], visibilidad: 'publica', estado: 'confirmado' },
	...
	{ id: 'participantes-gira', pregunta: '¿Quiénes participan de la Gira?', variantes: ['Participantes de la gira', '¿Cuántas personas participan?', '¿Cuántas cooperativas van a la gira?', '¿Quiénes son los beneficiarios?', '¿Cuántos representantes asistirán?'], respuesta: 'En la Gira de Innovación AGROCOOPINNOVA 2026 participan 15 representantes de 15 cooperativas.', categorias: ['participantes', 'asistentes', 'cooperativas', 'beneficiarios', 'quienes-van'], visibilidad: 'publica', estado: 'confirmado' },
	{
		id: 'nombre-oficial',
	...
	{ id: 'dispositivo', pregunta: '¿Necesito llevar un dispositivo con Internet?', variantes: ['¿Debo llevar celular?', '¿Necesito datos móviles?', '¿Hay que llevar computador o tablet?', '¿Es necesario tener Internet durante la gira?'], respuesta: 'Sí. Se recomienda llevar un celular, tablet o computador portátil con datos móviles. Un teléfono celular con acceso a Internet es suficiente.', categorias: ['recomendaciones', 'equipamiento'], visibilidad: 'publica', estado: 'confirmado' },
	...
	{ id: 'alojamiento', pregunta: '¿Cuál es el alojamiento de la Gira?', variantes: ['¿Cuál es el hotel de la gira?', '¿En qué hotel nos quedaremos?', '¿Dónde vamos a dormir?', '¿Cuál es la dirección del alojamiento?', '¿Dónde nos hospedaremos?'], respuesta: 'El nombre y la dirección de los alojamientos aún no están publicados en la información oficial disponible.', categorias: ['alojamiento', 'pendientes'], visibilidad: 'publica', estado: 'confirmado' },
	{
		id: 'emergencia-salud',
