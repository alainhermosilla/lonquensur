...
export const pendientesEditoriales: PendienteEditorial[] = [
	...
	{ id: 'cooperativas-participantes', tema: 'Cooperativas participantes', descripcion: 'La lista oficial de 15 cooperativas está incorporada sin nombres de representantes.', impactoRag: 'El asistente puede informar cooperativa, región y estado de envío de representante, sin publicar datos personales.', estado: 'confirmado' },
	...
	{ id: 'faqs', tema: 'Preguntas frecuentes', descripcion: 'Existe una colección oficial de preguntas y respuestas confirmadas.', impactoRag: 'Las respuestas directas y sus variantes forman parte de la evaluación automática.', estado: 'confirmado' },
